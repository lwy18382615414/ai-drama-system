...
Phase 1 is complete. Phase 2 media-generation work is paused.
...
The following Agents are future or paused until Phase 2 is explicitly resumed:
...
Do not add active media-generation routes, provider calls, queue jobs, or FFmpeg composition work as part of Phase 1 maintenance.
